...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "bg-terracotta text-primary-foreground hover:bg-terracotta-deep hover:-translate-y-px shadow-none rounded-none",
        terracotta:
          "bg-terracotta text-primary-foreground hover:bg-terracotta-deep hover:-translate-y-px rounded-none",
        outline:
          "border border-ink text-ink bg-transparent hover:bg-highlight rounded-none",
        ghost: "hover:bg-highlight text-ink rounded-none",
        link: "text-ink underline-offset-4 hover:underline",
        forest:
          "bg-forest text-primary-foreground hover:bg-forest-deep hover:-translate-y-px rounded-none",
        secondary:
